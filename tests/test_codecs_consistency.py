...
class Asn1ToolsCodecsConsistencyTest(Asn1ToolsBaseTest):
    ...
    def test_c_source(self):
        ...
        encoded_messages = [
            ...
            b'\x00\x05\x00\x82\x00\xa1\x07\x80\x01\xfc\x81\x02\x54\x55\xa2\x15'
            ...
            b'"f":null}}]',
            b'\x01\x01\x80\x00\x01\x03\x81\xfc\x02\x54\x55\xf0\x00\x02\x80\x03'
            b'\x03\x03\x03\x03\xff\xff',
