 ...
 'S1AP-Constants': {'extensibility-implied': False,
                    ...
                    'values': {'id-Additional-GUTI': {'type': 'ProtocolIE-ID',
                               ...
                               'maxProtocolIEs': {'type': 'INTEGER',
                                                  'value': 65535},
                               'maxnoofBPLMNs': {'type': 'INTEGER',
                                                 'value': 6},
                               'maxnoofCSGs': {'type': 'INTEGER',
                                               'value': 256},
                               ...
                               'maxnoofRestartTAIs': {'type': 'INTEGER',
                                                      'value': 2048},
                               'maxnoofTACs': {'type': 'INTEGER',
                                               'value': 256},
                               'maxnoofTAIforWarning': {'type': 'INTEGER',
                                                        'value': 65535},
                               'maxnoofTAIs': {'type': 'INTEGER',
                                               'value': 256},
              ...
              'types': {'Additional-GUTI': {'members': [{'name': 'gUMMEI',
                        ...
                        'EventType': {'type': 'ENUMERATED',
                                      'values': {0: 'direct',
                                                 ...
                                                 3: '...'}},
                        'ExpectedActivityPeriod': {'restricted-to': [(1,
                                                                      30),
                                                                     40,
                                                                     50,
                                                                     60,
                        ...
                        'HFNModified': {'restricted-to': [(0, 131071)],
                                        'type': 'INTEGER'},
                        'HFNforPDCP-SNlength18': {'restricted-to': [(0,
                                                                     16383)],
                                                  'type': 'INTEGER'},
                        ...
                        'MME-Group-ID': {'size': [2],
                                         'type': 'OCTET STRING'},
                        'MME-UE-S1AP-ID': {'restricted-to': [(0,
                                                              4294967295)],
                                           'type': 'INTEGER'},
                        ...
                        'MSClassmark2': {'size': None,
                                         'type': 'OCTET STRING'},
                        'MSClassmark3': {'size': None,
                                         'type': 'OCTET STRING'},
                        'ManagementBasedMDTAllowed': {'type': 'ENUMERATED',
                                                      'values': {0: 'allowed',
                                                                 1: '...'}},
                        'Masked-IMEISV': {'size': [64],
                                          'type': 'BIT STRING'},
                        ...
                        'NextPagingAreaScope': {'type': 'ENUMERATED',
                                                'values': {0: 'same',
                                                           1: 'changed',
                                                           2: '...'}},
                        'NumberOfBroadcasts': {'restricted-to': [(0,
                                                                  65535)],
                                               'type': 'INTEGER'},
                        ...
                        'Threshold-RSRQ': {'restricted-to': [(0, 34)],
                                           'type': 'INTEGER'},
                        'Time-UE-StayedInCell': {'restricted-to': [(0,
                                                                    4095)],
                                                 'type': 'INTEGER'},
