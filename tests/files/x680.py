X680 = {'X680': {'extensibility-implied': False,
          ...
          'types': {'A-19-5': {'type': 'ENUMERATED',
                    ...
                    'ABEnvelope-E-4': {'type': 'Envelope'},
                    'ACEnvelope-E-4': {'type': 'Envelope'},
                    ...
                    'Credentials-E-2-10': {'members': [{'name': 'userName',
                                                       ...
                                                       {'name': 'accountNumber',
                                                        ...
                                                        'type': 'INTEGER'}],
                                           'type': 'SEQUENCE'},
                    'CustomerAttribute-E-2-12': {'members': [{'name': 'name',
                                                              'optional': False,
                                                              'tag': {'kind': 'IMPLICIT',
                                                                      'number': 0},
                                                              'type': 'VisibleString'},
                                                             ...
                                                             {'name': 'balanceDue',
                                                              ...
                                                              'type': 'INTEGER'}],
                                                 'type': 'CHOICE'},
                    'CustomerRecord-E-2-12': {'members': [{'name': 'name',
                                                           'optional': False,
                                                           'tag': {'kind': 'IMPLICIT',
                                                                   'number': 0},
                                                           'type': 'VisibleString'},
                    ...
                    'Envelope-E-4': {'members': [{'name': 'typeA',
                                                 ...
                                                 {'name': 'typeC',
                                                  ...
                                                  'type': 'TypeC'}],
                                     'type': 'SET'},
                    'FileIdentifier-E-2-13': {'members': [{'name': 'relativeName',
                                                           'optional': False,
                                                           'type': 'VisibleString'},
                                                          {'name': 'absoluteName',
                                                           'optional': False,
                    ...
                    'G4FacsimileImage-E-2-6': {'size': None,
                                               'type': 'OCTET STRING'},
                    'Greeting-E-2-13': {'members': [{'name': 'postCard',
                                                     'optional': False,
                                                     'type': 'VisibleString'},
                                                    {'name': 'recording',
                                                     'optional': False,
                    ...
                    'PersonnelRecord-E-1-1': {'members': [{'name': 'name',
                                              ...
                                              'tag': {'class': 'APPLICATION',
                                                      'number': 0},
                                              'type': 'SET'},
                    'Record-E-2-10': {'members': [{'name': 'userName',
                                                   'optional': False,
                                                   'type': 'VisibleString'},
                                                  {'name': 'password',
                                                   'optional': False,
                    ...
                    'SmallPrime-E-4': {'restricted-to': [2,
                                                         3,
                                                         5,
                                                         7,
                                                         11,
                    ...
                    'UserName-E-2-11': {'members': [{'name': 'personalName',
                                                     'optional': False,
                                                     'type': 'VisibleString'},
          ...
          'values': {'acmeCorp-E-2-10': {'type': 'NamesOfOfficers-E-2-10',
                     ...
                     'dayOfTheMonth-E-2-2-c': {'type': 'DayOfTheMonth-E-2-2',
                                               'value': ['4']},
                     'file-E-2-13': {'type': 'FileIdentifier-E-2-13',
                                     'value': ['serialNumber',
                                               ':',
                                               ['106448503']]},
                     'fileId1-E-2-13': {'type': 'FileIdentifier-E-2-13',
                                        'value': ['relativeName',
                                                  ':',
                                                  ['MarchProgressReport.doc']]},
                     'fileId2-E-2-13': {'type': 'FileIdentifier-E-2-13',
                                        'value': ['serialNumber',
                                                  ':',
                                                  ['214']]},
                     'fileId3-E-2-13': {'type': 'FileIdentifier-E-2-13',
                                        'value': ['unidentified',
                                                  ':',
                                                  ['NULL']]},
                     ...
                     'map2-E-2-5': {'type': 'BitField-E-2-5',
                                    'value': ["'9A4'H"]},
                     'myGreeting-E-2-13': {'type': 'Greeting-E-2-13',
                                           'value': ['recording',
                                                     ':',
                                                     ['english',
                                                      ':',
                     ...
                     'unknown-E-2-2': {'type': 'DayOfTheMonth-E-2-2',
                                       'value': ['0']},
                     'user-E-2-11': {'type': 'UserName-E-2-11',
                                     'value': ['{',
                                               'personalName',
                                               ['Jonas Maruba'],
